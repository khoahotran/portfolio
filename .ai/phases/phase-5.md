# Content Roadmap — Phase 5

Part of the [content roadmap](../content-roadmap.md), split out 2026-09-08. Previous phases:
[early history (1-4)](early-history.md).
...
- No content currently sets `series:` — this is infrastructure ahead of use, not a feature with
  ...
  **Update (2026-09-07, [Phase 7](phase-7.md) §7.1): no longer true** — see below.
