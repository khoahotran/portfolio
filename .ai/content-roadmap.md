...
- [Phase 8 — Deliberately Slower, Picked Up One at a Time](phases/phase-8.md) — consistent hashing
  ...
  Bloom filters, Merkle trees, Raft, Two-Phase Commit vs. Saga, HyperLogLog, and LSM Trees
  (§8.1-8.10), across two Track B sets plus four directly-picked items. Both Track B sets closed out
  entirely — see `future.md` for what's next.
